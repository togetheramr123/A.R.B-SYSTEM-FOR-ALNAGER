  ...
  return <div className="space-y-3">
      ...
      <div className="flex items-center gap-3">
        ...
        <form onSubmit={handleSearch} className="relative flex-1 max-w-md">
          ...
          <input type="text" value={searchValue} onChange={e => setSearchValue(e.target.value)} placeholder="بحث..." className="w-full pr-10 pl-4 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none text-sm bg-gray-50/50" />{" "}
        </form>{" "}
        {/* Filter Button */}{" "}
