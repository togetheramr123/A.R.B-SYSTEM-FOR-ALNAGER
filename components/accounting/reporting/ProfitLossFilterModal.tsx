...
interface ProfitLossFilterModalProps {
  isOpen: boolean;
  onClose: () => void;
  journals: Journal[];
}
export function ProfitLossFilterModal({
  isOpen,
  onClose,
  journals
}: ProfitLossFilterModalProps) {
