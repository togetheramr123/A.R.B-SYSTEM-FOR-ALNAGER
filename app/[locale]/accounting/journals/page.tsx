      ...
      <div className="bg-white rounded-sm shadow-sm border border-gray-100 overflow-hidden">
        ...
        <div className="p-4 border-b border-gray-50 flex gap-4 items-center justify-between">
          ...
          <form className="relative flex-1 max-w-sm">
            ...
            <input type="text" name="search" defaultValue={search} placeholder="بحث بالكود أو الاسم..." className="w-full pr-10 pl-4 py-2 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-500 outline-none transition-all text-sm bg-gray-50/50" />{" "}
          </form>{" "}
